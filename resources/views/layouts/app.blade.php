...
<html lang="{{ app()->getLocale() }}">
	<head>
		...
		<meta charset="utf-8" />
		<meta name="description" content="Aplikasi berbasis monitoring jaringan BPKAD Provinsi NTB" />
		<meta name="keywords" content="BPKAD, Provinsi NTB, Network Monitoring, Aplikasi Monitoring Jaringan" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="id_ID" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="Monitoring Jaringan BPKAD Provinsi NTB" />
		<meta property="og:url" content="https://network-monitoring.ntbprov.go.id" />
		<meta property="og:site_name" content="Monitoring Jaringan BPKAD Provinsi NTB" />
        @include('layouts.css')
		</head>
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							<!--begin::Logo image-->
							<a href="/">
								<h4 class="text-gray-300 fw-bold fs-2">{{ session('identity') }}</h4>
                                <small class="fw-semibold text-gray-500 description">{{ session('model') }}</small>
